...
namespace Csharp_rgb_Color
{
    public partial class Form3 : Form
    {
        ...
        private void AllSystemCMYK()
        {
            ...
            if (Int32.TryParse(textBox1.Text, out var outparse1) && Int32.TryParse(textBox2.Text, out var outparse2) && Int32.TryParse(textBox3.Text, out var outparse3) && Int32.TryParse(textBox4.Text,out var outparse4))
            {
                //benar merupakan data angka
                Double c, y, m, k;
